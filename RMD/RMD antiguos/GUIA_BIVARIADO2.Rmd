---
title: "Análisis Bivariado con R"
...
```{r}
library(readr)
datos <- read_csv("C:/Users/esalom.UNINORTE/OneDrive - Universidad del Norte/CLASES/2. EST INFERENCIAL/INFERENCIAL/INFERENCIAL R/base_bebidas_azucaradas.csv")
View(base_bebidas_azucaradas)
```
