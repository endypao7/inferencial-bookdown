---
title: "INTERVALOS DE CONFIANZA Y PRUEBAS DE HIPÓTESIS: MEDIA Y PROPORCIÓN"
...
## Ejemplo visto en clase para un intervalo de confianza para media poblacional:
...
$$
_Recuerde que si la muestra es lo suficientemente grande, se utiliza la distribución Normla aunque la desviación estándar poblacional sea desconocida_
...
_Nota: Recuerde que lower.tail = FALSE es para que calcule la probabilidad acumulada por la derecha_
...
## Ejemplo visto en clase para una prueba de hipótesis para media poblacional:
...
## Ejemplo para un intervalo de confianza para la proporción
